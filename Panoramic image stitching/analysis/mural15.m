...
% Load images.
buildingDir = fullfile('/home/rahul/catkin_ws/src/image mosaicing/TOOLBOX_calib/original/2overlap15/reduced');
...
% Resizing the image to prevent the Out of memory error
%I = imresize(I,0.1,'nearest');

% Initialize features for I(1)
grayImage = im2gray(I);
%points = detectSURFFeatures(grayImage);
[y,x,m] = harris(grayImage,1500,'tile',[10 10],'thresh',1000,'disp');
points = [x, y];
...
for n = 2:numImages
    ...
    % Read I(n).
    I1 = readimage(buildingScene, n-1);
