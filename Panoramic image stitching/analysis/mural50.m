...
% Load images.
buildingDir = fullfile('/home/rahul/catkin_ws/src/image mosaicing/TOOLBOX_calib/original/2overlap50/reduced');
...
[y,x,m] = harris(grayImage,1000,'tile',[10 10],'thresh',1000,'disp');
points = [x, y];
